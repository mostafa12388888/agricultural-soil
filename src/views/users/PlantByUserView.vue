<template>
    <div>
      ...
      <v-container >
        <v-row no-gutters          v-if="plantData.length">
          <v-col
        ...
        <v-row v-else >
            <v-col class="text-center align-center" align="center">
                <span class="text-center align-center mt-20 primary" >
                    there is Not Any Plant <br/>
                    THIS User use Default Plant Only
  ...
  import EditPlant from "../../components/plant/EditPlant.vue";
